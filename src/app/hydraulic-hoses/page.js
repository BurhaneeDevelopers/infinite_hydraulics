  ...
  return (
    <div>
      ...
      <div className="my-10">
        <div className="mx-auto max-w-xl text-center my-10">
          ...
          <p className="mt-4 text-[#4F8A8B] max-w-lg mx-auto">
            A hydraulic hose is a specialist type of hose that you&apos;ll find
            in many commercial and industrial settings. Hydraulic hoses are
        ...
        <div className="flex flex-wrap justify-center gap-2">
          <button
            className="p-4 px-8 bg-gray-300 rounded-xl text-lg"
            onClick={() => handleFilter("all")}
          >
            All
          </button>
          <button
            className="p-4 px-8 bg-gray-200 rounded-md lg:text-lg md:w-1/5 lg:w-1/6"
        ...
        >
          {/* <!-- Product-1 --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic RubberHose">
            <img
            ...
            <div className="relative bg-white p-6">
              ...
              <div className="flex justify-between items-center">
                <p className="mt-1.5 text-sm text-gray-700 hidden">$14.99</p>
                <a
          ...
          {/* <!-- High Pressure Hoses --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic HighPressureHose">
            <img
          ...
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic WaterHose">
            <img
          ...
          {/* <!-- Thermo Plastic Hoses --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic ThermoHose">
            <img
          ...
          {/* <!-- Chemical Hose --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic ChemicalHose">
            <img
          ...
          {/* <!-- Composite Hoses --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic CompositeHose">
            <img
          ...
          {/* <!-- SS Teflon Hoses --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic TeflonHose">
            <img
          ...
          {/* <!-- Industrial Hoses --> */}
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic IndustrialHose">
            <img
          ...
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic AgriHose">
            ...
            <div className="relative bg-white p-6">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900 heading2">
                PVC Braided Hose
              </h3>
          ...
          <div className="group relative overflow-hidden w-full xs:w-1/2 sm:w-1/3 lg:w-1/4 border border-gray-300 rounded-xl shadow-xl hydraulic BelowHose">
            <img
      ...
      <div className="p-20 md:p-12">
        <div className="flex flex-col items-center text-center justify-center mb-10 md:mb-0">
        ...
        <section className="flex justify-center items-center">
          <div className="flex justify-center items-center" loading="lazy">
            <img
