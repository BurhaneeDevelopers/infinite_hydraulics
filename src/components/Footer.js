      ...
      <footer aria-label="Site Footer" class="bg-gray-100">
        <div class="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div class="text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl heading">
              Infinite <span class="text-[#4f8a8b]">Hydraulics </span>Solutions
            </h2>

            <p class="max-w-sm-25 mx-auto mt-4 text-gray-500">
          ...
          <div class="pt-8 mt-16 border-t border-gray-100 sm:flex sm:items-center sm:justify-between lg:mt-24">
            ...
            <ul class="flex justify-center items-center gap-6 mt-8 sm:mt-0 lg:justify-end">
              <li>
                <a
